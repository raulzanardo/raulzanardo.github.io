...
export default function Header({ isDark, setIsDark }) {
  ...
  const Sun = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="black">
      ...
      <line x1="4.22" y1="4.22" x2="5.64" y2="5.64" stroke="black" strokeWidth="2"/>
      <line x1="18.36" y1="18.36" x2="19.78" y2="19.78" stroke="black" strokeWidth="2"/>
      <line x1="1" y1="12" x2="3" y2="12" stroke="black" strokeWidth="2"/>
      <line x1="21" y1="12" x2="23" y2="12" stroke="black" strokeWidth="2"/>
      <line x1="4.22" y1="19.78" x2="5.64" y2="18.36" stroke="black" strokeWidth="2"/>
      <line x1="18.36" y1="5.64" x2="19.78" y2="4.22" stroke="black" strokeWidth="2"/>
    </svg>
  )
  ...
  return (
    <div className={`sticky top-0 z-50 ${isDark ? 'bg-surface-dark' : 'bg-surface'} shadow-md`}>
