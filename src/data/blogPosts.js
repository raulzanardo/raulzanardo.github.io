...
export const blogPosts = [
  {
    ...
    stars: 0,
    language: 'Python',
    content: 'A fork of a Spotify display project adapted for a large 192x128 HUB75 LED matrix panel. Displays currently playing track information, album artwork, and dynamic visualizations synchronized with your Spotify account. Built with Python using the Spotify Web API and the rpi-rgb-led-matrix library.'
  },
  {
    id: 'my-led-matrix',
    slug: 'my-led-matrix',
    ...
    stars: 0,
    language: 'C++',
    content: 'A collection of utilities, demos, and documentation for working with HUB75 RGB LED matrix panels. Includes hardware setup guides, wiring diagrams, and example code for driving large LED displays from Raspberry Pi and other single-board computers.'
  },
  {
    id: 'curriculo-react',
    ...
    stars: 0,
    language: 'TypeScript',
    content: 'A responsive portfolio website showcasing professional experience, projects, and skills. Built with React 18, TypeScript, and Vite, featuring smooth animations and modern UI design. Automatically deployed to GitHub Pages using GitHub Actions CI/CD pipeline.'
  },
  {
    ...
    date: '2026-01-10',
    excerpt: 'Over-the-air firmware updates for LibreTiny microcontroller boards.',
    image: null,
    images: [],
    ...
    stars: 0,
    language: 'C++',
    content: 'Lightweight OTA (Over-The-Air) update infrastructure for LibreTiny-based IoT devices. Enables remote firmware updates with minimal bootloader overhead, checksum verification for security, and easy integration into existing projects using PlatformIO.'
  },
  {
    ...
    stars: 0,
    language: 'Dart',
    content: 'A Flutter implementation of the portfolio showcasing cross-platform capabilities. Features responsive layouts that adapt to different screen sizes, smooth animations, and can be deployed to Android, iOS, web, and desktop platforms from a single codebase.'
  },
  {
    ...
    date: '2026-01-07',
    excerpt: 'Retro-style pixel art camera application for ESP32-S3 with real-time filters.',
  ...
  },
  {
    ...
    date: '2025-12-28',
    excerpt: 'ESP32-S3 clock display with Spotify album art on a 64x64 LED matrix.',
    ...
    tags: ['ESP32-S3', 'Spotify', 'LED Matrix', 'Clock', 'Music'],
    github: 'https://github.com/raulzanardo/spotify_clock_mps3',
    stars: 2,
    language: 'C++',
    content: 'A smart clock display for the Adafruit Matrix Portal S3 that shows currently playing Spotify tracks on a 64x64 LED matrix. Features album artwork display, color extraction from artwork to adjust clock colors dynamically, and shows date/time when no music is playing. Connects to Spotify Web API over WiFi.'
  },
  {
    id: 'xserver-screen',
    slug: 'xserver-screen',
    ...
    stars: 1,
    language: 'C++',
    content: 'Capture and render any X11 application to an RGB LED matrix display in real-time. Uses Xvfb virtual framebuffer to create a virtual display that gets captured and sent to HUB75 LED panels. Perfect for retro gaming (DOOM, Quake, Celeste), dashboards, or any graphical application. Based on pico8-led but generalized for any X application.'
  }
];
